...
**Note**: for **fastText** search engine, you also need to download [pre-trained **fastText** model](http://vectors.nlpl.eu/repository/11/181.zip) and unzip it to the directory with all necessary files. </br>
